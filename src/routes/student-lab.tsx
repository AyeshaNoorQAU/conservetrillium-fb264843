  ...
  head: () => ({
    meta: [
      { title: "Student Lab — Interactive Botany | ConserveTrillium" },
      {
        name: "description",
        content:
          "A first-of-its-kind interactive lab for students of ethnobotany and conservation: 3D flashcards, an altitude explorer, a saponin builder, and a knowledge gauntlet.",
      },
    ],
  }),
...
const cards: Card[] = [
  {
    ...
    tag: "Species",
    emoji: "🌸",
    back: "Rhizomatous Melanthiaceae perennial of Himalayan forests, 2,400–3,300 m. Single maroon trillium flower above three whorled leaves.",
  },
  {
    term: "Steroidal Saponins",
    tag: "Phytochemistry",
    emoji: "⚗️",
    back: "Govanoside A and related saponins drive anti-inflammatory and anti-cancer bioactivity — chiefly extracted from the rhizome.",
  },
  {
    term: "Ex-situ Conservation",
    tag: "Strategy",
    emoji: "🌱",
    back: "Off-site preservation in botanic gardens, seed banks and tissue-culture labs — complements in-situ protection against catastrophic loss.",
  },
  {
    term: "MaxEnt Modelling",
    tag: "GIS",
    emoji: "🗺️",
    back: "Maximum-entropy SDM uses presence-only occurrences + bioclimatic layers to map suitable habitat — guiding where to act.",
  },
  {
    term: "Use-Value (UV)",
    tag: "Ethnobotany",
    emoji: "📊",
    back: "UV = Σ(uses reported by informants) / N. Quantifies local importance of a species in traditional knowledge surveys.",
  },
  {
    term: "IUCN Red List",
    tag: "Policy",
    emoji: "🛡️",
    back: "Global authority on extinction risk: LC → NT → VU → EN → CR → EW → EX. Trillium govanianum is listed Endangered.",
  },
];
...
const zones = [
  {
    min: 1500,
    max: 2400,
    name: "Sub-tropical pine",
    species: ["Pinus roxburghii", "Olea ferruginea"],
    color: "var(--accent)",
  },
  {
    min: 2400,
    ...
    species: ["Trillium govanianum", "Aconitum heterophyllum"],
    color: "var(--moss)",
  },
  {
    min: 2500,
    max: 4000,
    name: "Sub-alpine meadows",
    species: ["Dactylorhiza hatagirea", "Podophyllum hexandrum"],
    color: "var(--primary)",
  },
  {
    min: 4000,
    max: 5000,
    name: "Alpine cushion",
    species: ["Saussurea spp.", "Rhododendron anthopogon"],
    color: "var(--ember)",
  },
];
    ...
    <div className="grid lg:grid-cols-5 gap-8 items-center">
      <div className="lg:col-span-2">
        <div className="relative h-[440px] rounded-2xl overflow-hidden bg-gradient-to-b from-[#bcd7e6] via-[#a8c5a3] to-[#5a7a4f] border border-border">
          ...
          >
            <polygon
              points="0,300 40,140 80,220 120,80 170,200 200,160 200,300"
              fill="rgba(255,255,255,0.18)"
            />
            <polygon
              points="0,300 30,200 70,260 110,180 160,250 200,220 200,300"
      ...
      <div className="lg:col-span-3 space-y-3">
        <p className="text-xs uppercase tracking-[0.3em] text-accent">
          Active vegetation zones at {alt.toLocaleString()} m
        </p>
        {active.length === 0 && (
          <p className="text-muted-foreground">No active zone — move the slider.</p>
        )}
        {active.map((z) => (
          <div key={z.name} className="p-5 rounded-2xl border border-border bg-card">
            <div className="flex items-center gap-3 mb-2">
              <span
                ...
                style={{
                  background: `var(--${z.color === "var(--primary)" ? "primary" : z.color === "var(--moss)" ? "moss" : z.color === "var(--accent)" ? "accent" : "ember"})`,
                }}
              />
    ...
    <div className="grid lg:grid-cols-2 gap-8 items-center">
      <Tilt3D max={14}>
        <div className="aspect-square rounded-3xl bg-gradient-to-br from-secondary via-card to-secondary/40 border border-border p-6 relative overflow-hidden">
          ...
          <svg viewBox="0 0 100 100" className="relative w-full h-full">
            ...
            <text x="50" y="52" textAnchor="middle" fontSize="6" fill="white" fontWeight="bold">
              Aglycone
            </text>
            {positions.map((p, i) => (
              <g key={i}>
      ...
      <div>
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Trillium's govanoside A is a steroidal saponin: an aglycone core with sugar chains. Adjust
          the molecule and watch predicted properties shift.
        </p>
...
const questions: Q[] = [
  {
    q: "Which family does Trillium govanianum belong to?",
    opts: ["Liliaceae", "Melanthiaceae", "Orchidaceae", "Ranunculaceae"],
    correct: 1,
    why: "Once placed in Liliaceae, Trillium is now classified within Melanthiaceae based on molecular phylogenetics.",
  },
  {
    q: "What is the chief bioactive class in T. govanianum rhizomes?",
    opts: ["Alkaloids", "Tannins", "Steroidal saponins", "Flavonoids"],
    correct: 2,
    why: "Steroidal saponins — chiefly govanoside A — underpin its medicinal and economic value.",
  },
  {
    q: "What altitude range does it primarily occupy in Pakistan?",
    opts: ["500–1,500 m", "1,800–2,200 m", "2,400–3,300 m", "4,500–5,500 m"],
    correct: 2,
    why: "Moist temperate forests at 2,400–3,300 m form its core habitat in the western Himalayas.",
  },
  {
    q: "Which threat is most acute for T. govanianum populations?",
    opts: ["Wildfire", "Unsustainable rhizome harvesting", "Air pollution", "Coastal erosion"],
    correct: 1,
    why: "Underground rhizome harvest removes the whole genet — and the species takes years to mature.",
  },
  {
    q: "Use-Value (UV) in ethnobotany measures…",
    opts: [
      "Plant biomass",
      "Species per quadrat",
      "Relative importance from informant reports",
      "Soil pH preference",
    ],
    correct: 2,
    why: "UV = Σ uses reported / N informants — a standard quantitative ethnobotany metric.",
  },
  {
    q: "Which conservation approach grows plants outside their natural habitat?",
    opts: ["In-situ", "Ex-situ", "Reintroduction", "Translocation"],
    correct: 1,
    why: "Ex-situ conservation (gardens, gene banks, tissue culture) safeguards against catastrophic in-situ loss.",
  },
];
  ...
  if (done) {
    ...
    return (
      <div className="text-center py-10">
        ...
        <h3 className="mt-4 text-display text-3xl">
          You scored {score} / {questions.length}
        </h3>
        <p className="mt-2 text-muted-foreground">
          {pct === 100
            ? "Outstanding — you're ready for the field."
            : pct >= 70
              ? "Strong showing. Review the explanations and try again."
              : "A great start. The flashcards above will help."}
        </p>
        <button
          onClick={() => {
            setI(0);
...
const glossary = [
  {
    term: "Aglycone",
    def: "The non-sugar portion of a glycoside molecule (e.g. the steroidal core of govanoside A).",
  },
  {
    term: "Allelopathy",
    def: "Chemical inhibition of one plant by another via released metabolites.",
  },
  { term: "Endemic", def: "Native and restricted to a particular geographic region." },
  {
    term: "Genet",
    def: "A genetically distinct individual; for rhizomatous plants, the whole underground clone.",
  },
  {
    term: "Habitat suitability",
    def: "Modelled probability that a location can sustain a given species.",
  },
  ...
  return (
    <div>
      <input
        ...
        placeholder="Search the field glossary…"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <header className="max-w-3xl mb-12 fade-up">
            <p className="text-xs uppercase tracking-[0.3em] text-accent mb-6">
              First-of-its-kind · Pakistan
            </p>
            <h1 className="text-display text-5xl lg:text-7xl leading-[1.02] text-balance">
              The <span className="italic text-[var(--moss)]">Student Lab</span> — interactive
              ethnobotany for the curious.
            </h1>
            <p className="mt-6 text-muted-foreground leading-relaxed text-lg">
              Flip 3D flashcards, climb the Himalayan altitude gradient, assemble a saponin
              molecule, and test yourself in the knowledge gauntlet. Built so students of plant
              sciences, pharmacology, and conservation can <em>do</em> botany, not just read it.
            </p>
          </header>
          ...
          >
            <SectionHeader
              ...
              kicker="Module 01"
              title="3D Flashcards"
              sub="Tap to flip. Hover for parallax."
            />
            <Flashcards />
          </section>
          ...
          >
            <SectionHeader
              ...
              sub="Drag the slider to see which species share an altitudinal niche."
            />
            <AltitudeExplorer />
          </section>
          ...
          >
            <SectionHeader
              icon={FlaskConical}
              kicker="Module 03"
              title="Saponin Builder"
              sub="Add sugars and hydroxyl groups; see bioactivity respond."
            />
            <SaponinBuilder />
          </section>
          ...
          >
            <SectionHeader
              icon={Brain}
              kicker="Module 04"
              title="Knowledge Gauntlet"
              sub="Six questions. Instant feedback with the reasoning behind each answer."
            />
          ...
          >
            <SectionHeader
              ...
              sub="Search terms you'll encounter in fieldwork and publications."
            />
          ...
          <div className="mt-20 p-8 rounded-2xl bg-gradient-to-br from-primary/10 via-card to-secondary border border-primary/30 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Drop a suggestion on the home page — every idea reaches Ayesha directly.
            </p>
            <Link
              to="/"
              hash="contact"
