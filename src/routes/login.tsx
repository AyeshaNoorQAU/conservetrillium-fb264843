  ...
  return (
    <div className="min-h-screen grid place-items-center bg-secondary/30 px-6 py-16">
      <div className="w-full max-w-md">
        <Link to="/" className="inline-flex items-center gap-2 mb-8 text-muted-foreground hover:text-primary">
          <span className="grid place-items-center w-9 h-9 rounded-full bg-primary text-primary-foreground">
            <Leaf className="w-4 h-4" />
          </span>
          <span className="text-display text-lg">Conserve<em> Trillium</em></span>
        </Link>
        ...
        <p className="mt-6 text-[11px] text-center text-muted-foreground leading-relaxed">
          After signing up the first time, contact your project owner to grant <code className="px-1 rounded bg-secondary">admin</code> role.
        </p>
      </div>
    </div>
  );
