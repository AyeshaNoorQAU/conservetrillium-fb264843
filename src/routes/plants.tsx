  ...
  head: () => ({
    meta: [
      { title: "Endangered Himalayan Medicinal Plants — ConserveTrillium" },
      {
        name: "description",
        content:
          "Profiles of four endangered medicinal plants of the Pakistani Himalayas — Trillium govanianum, Dactylorhiza hatagirea, Aconitum heterophyllum, and Podophyllum hexandrum — with interactive zoomable photography.",
      },
      { property: "og:title", content: "Endangered Himalayan Medicinal Plants" },
      {
        property: "og:description",
        content:
          "Interactive botanical profiles of four endangered Himalayan medicinal species under conservation by PMNH.",
      },
    ],
  }),
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <header className="max-w-3xl mb-16 fade-up">
            <p className="text-xs uppercase tracking-[0.3em] text-accent mb-6">
              Field herbarium · interactive
            </p>
            <h1 className="text-display text-5xl lg:text-7xl leading-[1.02] text-balance">
              Four endangered{" "}
              <span className="italic text-[var(--moss)]">jewels</span> of the
              Pakistani Himalayas.
            </h1>
            <p className="mt-6 text-muted-foreground leading-relaxed text-lg">
              Each plant below can be explored in detail — click <em>Zoom &amp;
              pan</em> on any image to inspect leaf venation, floral structure,
              and rhizome morphology from any angle.
            </p>
          </header>
          ...
          <div className="space-y-24">
            {plants.map((p, i) => (
              <article
                key={p.slug}
                id={p.slug}
                className={`grid lg:grid-cols-12 gap-10 lg:gap-16 items-center fade-up ${
              ...
              >
                ...
                <div className="lg:col-span-6">
                  ...
                  <div className="mt-7 inline-flex items-start gap-2 text-xs text-muted-foreground bg-secondary/50 border border-border rounded-xl px-4 py-3">
                    ...
                    Listed under regional conservation priority — wild harvesting
                    is regulated; cultivation and ex-situ propagation are
                    actively encouraged.
                  </div>
                </div>
              </article>
    ...
    <div className="border-t border-border pt-3">
      ...
      <dd
        className={`mt-1.5 text-[15px] leading-snug ${
          accent ? "text-ember font-medium" : "text-foreground"
        }`}
      >
        {value}
      </dd>
