      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
          <div className="lg:col-span-5">
            <p className="text-xs uppercase tracking-[0.3em] text-accent mb-6">Get in touch</p>
            ...
            <p className="mt-6 text-muted-foreground leading-relaxed">
              Whether you are a researcher, conservationist, journalist, student, or a community
              member from the Himalayan valleys — we would love to hear from you.
            </p>
          </div>
