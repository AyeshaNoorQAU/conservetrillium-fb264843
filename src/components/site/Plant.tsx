        ...
        <div className="mt-16 grid lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-7">
            <p className="text-lg leading-relaxed text-foreground/90">
              First described in the 19th century, <em>Trillium govanianum</em>{" "}
              produces a single deep-maroon bloom held above three broad leaves.
              Its rhizome — rich in steroidal saponins — has been a cornerstone
              of Himalayan ethnomedicine for centuries.
            </p>
            <p className="mt-5 text-muted-foreground leading-relaxed">
              But this slow-growing species takes years to mature, and its
              limited distribution makes every uprooted plant a permanent loss
              to the ecosystem. Listed on the{" "}
              <strong className="text-foreground">IUCN Red List as Endangered</strong>,
              its survival now depends entirely on coordinated conservation.
            </p>
            ...
            <dl className="mt-10 grid sm:grid-cols-2 gap-x-8 gap-y-6">
              {facts.map((f) => (
                <div key={f.label} className="border-t border-border pt-4">
                  ...
                  <dd className="mt-2 text-foreground text-[15px] leading-snug">
                    {f.value}
                  </dd>
                </div>
              ))}
