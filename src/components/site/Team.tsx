...
const team = [
  ...
  { name: "Dr. Amir Hussain", role: "Assistant in Project Activities, PMNH", initials: "AH" },
  { name: "Syed Munir Hussain", role: "Sr. Collection In-Charge, PMNH", initials: "SM" },
  { name: "Mr. Sabih-ul-Hassan", role: "Project-Recruited Field Worker", initials: "SH" },
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          <div className="relative grid lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-9">
              ...
              <p className="text-sm text-muted-foreground mt-1 italic">
                Founder of ConserveTrillium · M.Phil. Researcher, Department of Plant Sciences, Quaid-i-Azam University
              </p>
              <p className="mt-5 text-foreground/90 leading-relaxed text-[15px]">
                I built ConserveTrillium to give Pakistan's endangered Himalayan medicinal flora a
                voice on the open web — a place where field photographs, traditional knowledge,
                peer-reviewed science, and student learning can meet. This is more than a website;
                it is a small act of stewardship for plants that have healed our communities for
                centuries.
              </p>
              <div className="mt-5 flex flex-wrap gap-3">
                <a href="mailto:ayesha.22413028@bps.qau.edu.pk" className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-border bg-background text-xs hover:border-primary/40 hover:text-primary transition-colors">
                  <Mail className="w-3.5 h-3.5" /> ayesha.22413028@bps.qau.edu.pk
                </a>
                <a href="https://www.researchgate.net/profile/Ayesha-Noor-14" target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-border bg-background text-xs hover:border-primary/40 hover:text-primary transition-colors">
        ...
        <div className="max-w-3xl mb-16 fade-up">
          ...
          <p className="mt-6 text-muted-foreground leading-relaxed">
            This project exists because of the unwavering vision, scholarship, and field labour
            of a small team committed to the survival of <em>Trillium govanianum</em> in the
            Pakistani Himalayas.
          </p>
        </div>
          ...
          {team.map((m, i) => (
            ...
            >
              ...
              <div className="mb-5 relative w-20 h-20">
                ...
                {m.photo ? (
                  <img src={m.photo} alt={m.name} className="relative w-20 h-20 rounded-full object-cover ring-2 ring-border group-hover:ring-primary/50 transition-all duration-500" />
                ) : (
              ...
              <div className="mt-5 space-y-2">
                {m.email && (
                  <a href={`mailto:${m.email}`} className="flex items-center gap-2 text-xs text-primary hover:underline break-all">
                    <Mail className="w-3.5 h-3.5 shrink-0" /> {m.email}
                  </a>
                )}
                {m.researchgate && (
                  <a href={m.researchgate} target="_blank" rel="noreferrer noopener" className="flex items-center gap-2 text-xs text-[var(--moss)] hover:underline">
                    <ExternalLink className="w-3.5 h-3.5 shrink-0" /> ResearchGate profile
                  </a>
                )}
              </div>
            </div>
          ...
          <div className="relative grid lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-2 flex lg:justify-center">
              <div className="relative">
                ...
                <img src={mushtaq} alt="Dr. Mushtaq Ahmad" className="relative w-28 h-28 rounded-full object-cover ring-4 ring-background shadow-[var(--shadow-elevated)]" />
            ...
            <div className="lg:col-span-7">
              <p className="text-[11px] uppercase tracking-[0.3em] text-accent mb-3">With deepest respect</p>
              <h3 className="text-display text-2xl sm:text-3xl text-foreground leading-snug">Dr. Mushtaq Ahmad</h3>
              <p className="text-sm text-muted-foreground mt-1 italic">
                Academic Supervisor — Department of Plant Sciences, Quaid-i-Azam University
              </p>
              <p className="mt-5 text-muted-foreground leading-relaxed text-[15px]">
                With profound gratitude, I dedicate this work to my esteemed supervisor, whose
                scholarly wisdom and gentle mentorship have been a guiding light throughout my
                research journey. His patience, vision, and unwavering belief in ethnobotanical
                science have shaped every step of this endeavour. It is a privilege to learn
                under his care.
              </p>
            </div>
            <div className="lg:col-span-3 lg:text-right">
              <a href="https://www.researchgate.net/profile/Mushtaq-Ahmad-48" target="_blank" rel="noreferrer noopener" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full border border-border bg-background text-sm text-foreground hover:border-primary/40 hover:text-primary transition-colors">
