          ...
          <div className="relative grid lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-9">
              ...
              <p className="text-sm text-muted-foreground mt-1 italic">
                Founder of ConserveTrillium · M.Phil. Researcher, Department of Plant Sciences,
          ...
          <div className="relative grid lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <p className="mt-5 text-muted-foreground leading-relaxed text-[15px]">
                ...
                science have shaped every step of this endeavour. It is a privilege to learn under
                his care.
              </p>
            </div>
